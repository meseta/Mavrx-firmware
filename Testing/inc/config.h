...
#define UART_PRIORITY       3           // UART interrupt priority
...
#define SSP0_PRIORITY       3           // SSP interrupt priority


#define SSP1_EN             1           // Set to 1 to enable SSP0

#define SSP1_SIZE           8         	// Transfer size in bits (valid values are 4-bit to 16-bit)
