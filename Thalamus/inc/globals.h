...
#define MESSAGE_LOOP_HZ	 	50		  	/*!< Max frequency of ilink param messages in Hz (keep this number low, like around 20) */
...
#define RX_PANIC			RX_PANIC_SECONDS*SLOW_RATE*2	/*!< Number of loop iterations that is used to obtain the correct RX_PANIC period, the times 2 is because we run the receive function twice per slow loop */
