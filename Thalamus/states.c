...
void arm(void) {
	...
	PWMSetNESW(MIDDLE, MIDDLE, MIDDLE, MIDDLE);

	if(armed == 0) {
		Delay(500);
		PWMSetNESW(MIDDLE + IDLETHROTTLE, MIDDLE + IDLETHROTTLE, MIDDLE + IDLETHROTTLE, MIDDLE + IDLETHROTTLE);
		Delay(100);
		PWMSetNESW(MIDDLE, MIDDLE, MIDDLE, MIDDLE);
		Delay(300);
		PWMSetNESW(MIDDLE + IDLETHROTTLE, MIDDLE + IDLETHROTTLE, MIDDLE + IDLETHROTTLE, MIDDLE + IDLETHROTTLE);
...
void disarm(void) {
	if(armed) {
		...
		PWMSetN(MIDDLE + IDLETHROTTLE);
		Delay(100);
		PWMSetN(MIDDLE);
		Delay(33);
		PWMSetE(MIDDLE + IDLETHROTTLE);
		Delay(100);
		PWMSetE(MIDDLE);
		Delay(33);
		PWMSetS(MIDDLE + IDLETHROTTLE);
		Delay(100);
		PWMSetS(MIDDLE);
		Delay(33);
		PWMSetW(MIDDLE + IDLETHROTTLE);
		Delay(100);
		PWMSetW(MIDDLE);
